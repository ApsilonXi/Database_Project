...
--
-- Name: convert_status(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.convert_status() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.convert_status() OWNER TO postgres;

--
-- Name: convert_type_invoice(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.convert_type_invoice() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.convert_type_invoice() OWNER TO postgres;
...
--
-- Name: update_invoice_details_based_on_role(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.update_invoice_details_based_on_role() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.update_invoice_details_based_on_role() OWNER TO postgres;
...
CREATE VIEW public.invoice_details_view AS
 SELECT inv.invoice_id,
    ...
    inv.date_time,
        CASE
            WHEN (inv.type_invoice = true) THEN 'выгрузка'::text
            ELSE 'отгрузка'::text
        END AS type_invoice,
        CASE
            WHEN (inv.status = true) THEN 'завершено'::text
...
SELECT pg_catalog.setval('public.log_table_log_id_seq', 54, true);
...
--
-- Name: invoice set_status; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_status BEFORE INSERT OR UPDATE ON public.invoice FOR EACH ROW EXECUTE FUNCTION public.convert_status();


--
-- Name: invoice set_type_invoice; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER set_type_invoice BEFORE INSERT OR UPDATE ON public.invoice FOR EACH ROW EXECUTE FUNCTION public.convert_type_invoice();
...
--
-- Name: FUNCTION convert_status(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.convert_status() TO warehouse_owner;


--
-- Name: FUNCTION convert_type_invoice(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.convert_type_invoice() TO warehouse_owner;
...
--
-- Name: FUNCTION update_invoice_details_based_on_role(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.update_invoice_details_based_on_role() TO warehouse_owner;
